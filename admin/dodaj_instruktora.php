...
<!-- Edytowalna treść strony -->
		...
		<div class="content_box d-flex flex-column align-items-center justify-content-end pt-4 pb-0 w-100-m h-100-custom border_top_radius mt_60">
			<div class="content_box d-flex flex-column align-items-center justify-content-start px-4 w-100 bg-white border_top_radius h-100-custom2">
				<h5 class="text-secondart text-center mb-3 screen-title pb-2">Nowy instruktor</h5>
				<form action="instruktorzy.php" method="POST" class="w-100 d-flex flex-column align-items-center">
					<input type="text" required placeholder="Imie" name="imie" class="form_input"><br>
					...
					<select name="rola" class="form_input" required>
						...
						<option value="2">Instruktor praktyki</option>
					</select><br>
					...
					<input type="submit" value="Dodaj instruktora" class="btn_bnb btn-primary_bnb">
				</form>
