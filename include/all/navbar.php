	<div class="navbar d-flex justify-content-between align-items-start w-100 pt-3" style="<?php if ($pagetitle == 'Logowanie' || $pagetitle == 'Sukces') {echo 'height: 50px;';} else {echo 'height: 50px;';} ?>">
		...
		if ($pagetitle == 'Start') {
				...
				if ($pagetitle == 'Logowanie' || $pagetitle == 'Sukces') {
					echo '<div class="logo_nav logo_nav_big"><img src="img/logo_nav.svg" alt="logo"></div>';
				} else {
					echo '<div class="logo_nav"><img src="img/logo_nav.svg" alt="logo"></div>';
				}
			}
		...
		<div class="dropdown">
			...
			<div class="dropdown-content">
				<a href="#">Start</a>
				<a href="#">Moje konto</a>
				<form class="wyloguj py-2 pb-3 pl-2" method="POST" action="index.php"><input type="submit" value="Wyloguj"></form>
			</div>
		</div>
		';
		} else {
